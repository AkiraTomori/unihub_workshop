...
VALUES 
  ('66666666-6666-6666-6666-666666666666', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 'CONFIRMED', NULL, 'QR-ALICE-0001'),
  ('77777777-7777-7777-7777-777777777777', '33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', 'PENDING_PAYMENT', NOW() + INTERVAL '15 minutes', 'QR-BOB-0001'),
  ('aaaa1111-aaaa-1111-aaaa-111111111111', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 'CANCELLED', NULL, 'QR-ALICE-0002'),
  ('e1111111-e111-4111-8111-111111111111', 'ccccc111-cccc-4ccc-8ccc-cccccccccccc', 'f1111111-f111-4111-8111-111111111111', 'CONFIRMED', NULL, 'UNI-2026-DEVOPS-HUY'),
  ('e2222222-e222-4222-8222-222222222222', 'ccccc111-cccc-4ccc-8ccc-cccccccccccc', 'f2222222-f222-4222-8222-222222222222', 'CONFIRMED', NULL, 'UNI-2026-CLOUD-HUY'),
  ('e3333333-e333-4333-8333-333333333333', 'd1111111-d111-4111-8111-111111111111', 'f5555555-f555-4555-8555-555555555555', 'CONFIRMED', NULL, 'UNI-2026-UIUX-HA'),
  ('e4444444-e444-4444-8444-444444444444', 'd2222222-d222-4222-8222-222222222222', 'f5555555-f555-4555-8555-555555555555', 'CONFIRMED', NULL, 'UNI-2026-UIUX-MINH'),
  ('e5555555-e555-4555-8555-555555555555', 'd3333333-d333-4333-8333-333333333333', 'f6666666-f666-4666-8666-666666666666', 'PENDING_PAYMENT', NOW() - INTERVAL '30 minutes', 'UNI-2026-GALA-KHOA'),
  ('e6666666-e666-4666-8666-666666666666', 'd4444444-d444-4444-8444-444444444444', 'f6666666-f666-4666-8666-666666666666', 'CONFIRMED', NULL, 'UNI-2026-GALA-VY'),
  ('e7777777-e777-4777-8777-777777777777', 'd5555555-d555-4555-8555-555555555555', 'f6666666-f666-4666-8666-666666666666', 'CONFIRMED', NULL, 'UNI-2026-GALA-PHONG'),
  ('e8888888-e888-4888-8888-888888888888', '22222222-2222-2222-2222-222222222222', 'f7777777-f777-4777-8777-777777777777', 'CANCELLED', NULL, 'UNI-2026-BLOCK-ALICE')
ON CONFLICT DO NOTHING;
