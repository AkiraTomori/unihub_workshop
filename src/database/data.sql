...
-- WORKSHOPS
-- -------------------------
INSERT INTO workshops (id, room_id, title, description, cover_image_url, start_time, end_time, capacity, registered_count, price, status)
VALUES
	('44444444-4444-4444-4444-444444444444', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Career Prep: Resume & Interview', 'Practical workshop on resumes and interviews for new graduates.', 'https://placehold.co/1200x400?text=Career+Prep', NOW() + INTERVAL '7 days', NOW() + INTERVAL '7 days' + INTERVAL '2 hours', 60, 2, 100.00, 'PUBLISHED'),
	('55555555-5555-5555-5555-555555555555', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Intro to Web Dev', 'Beginner-friendly introduction to building web apps with JavaScript.', 'https://placehold.co/1200x400?text=Web+Dev', NOW() + INTERVAL '8 days', NOW() + INTERVAL '8 days' + INTERVAL '2 hours', 40, 0, 0.00, 'DRAFT'),
	('wwwww111-wwww-4www-8www-wwwwwwwwwww1', '22222222-2222-4222-8222-222222222222', 'DevOps Thực chiến: Triển khai CI/CD với Docker và Kubernetes', 'Hướng dẫn cấu hình pipeline tự động hóa với Jenkins và ArgoCD. Thực hành triển khai hệ thống Microservices.', 'https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=800&q=80', '2026-05-15 08:00:00+07', '2026-05-15 11:30:00+07', 60, 1, 50000.00, 'PUBLISHED'),
	('wwwww111-wwww-4www-8www-wwwwwwwwwww2', '11111111-1111-4111-8111-111111111111', 'Tối ưu Chi phí Cloud: Thiết kế hệ thống Serverless Zero-Cost', 'Cách sử dụng AWS Lambda, API Gateway và GCP để host các dự án cá nhân, đồ án môn học mà không tốn một đồng chi phí nào.', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80', '2026-05-18 13:00:00+07', '2026-05-18 16:00:00+07', 500, 1, 0.00, 'PUBLISHED'),
	('wwwww111-wwww-4www-8www-wwwwwwwwwww3', '33333333-3333-4333-8333-333333333333', 'Kỹ năng Sư phạm: Lên giáo án chạy nước rút ôn thi Toán vào 10', 'Dành cho các bạn sinh viên đang làm gia sư. Cách thiết kế lộ trình 5 tuần cuối cùng giúp học sinh bứt phá môn Toán.', 'https://images.unsplash.com/photo-1632516643720-e7f0d7e6a739?w=800&q=80', '2026-05-22 09:00:00+07', '2026-05-22 11:00:00+07', 30, 0, 0.00, 'PUBLISHED'),
	('wwwww111-wwww-4www-8www-wwwwwwwwwww4', '33333333-3333-4333-8333-333333333333', 'Phân tích Kịch bản Điện ảnh: Góc nhìn từ Kamen Rider Zero-One', 'Thảo luận về cách xây dựng thế giới AI, mâu thuẫn giữa con người và máy móc thông qua series đình đám.', 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&q=80', '2026-06-05 14:00:00+07', '2026-06-05 16:30:00+07', 30, 0, 0.00, 'DRAFT')
ON CONFLICT DO NOTHING;
...
VALUES
	...
	(gen_random_uuid(), 'wwwww111-wwww-4www-8www-wwwwwwwwwww1', 'https://cdn.unihub.edu.vn/docs/devops-k8s-guide.pdf', 'Tài liệu hướng dẫn chi tiết các bước thiết lập môi trường Minikube, viết Dockerfile cho ứng dụng Node.js và cấu hình CI/CD tự động bằng ArgoCD.', 'COMPLETED')
ON CONFLICT DO NOTHING;
...
VALUES
	...
	('77777777-7777-7777-7777-777777777777', '33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', 'PENDING_PAYMENT', NOW() + INTERVAL '15 minutes', 'QR-BOB-0001', 'offline-sync-uuid-0001'),
	...
	('rrrrr111-rrrr-4rrr-8rrr-rrrrrrrrrrr1', 'ccccc111-cccc-4ccc-8ccc-cccccccccccc', 'wwwww111-wwww-4www-8www-wwwwwwwwwww1', 'CONFIRMED', NULL, 'UNI-2026-W1-C111', NULL),
	('rrrrr111-rrrr-4rrr-8rrr-rrrrrrrrrrr2', 'ccccc111-cccc-4ccc-8ccc-cccccccccccc', 'wwwww111-wwww-4www-8www-wwwwwwwwwww2', 'CONFIRMED', NULL, 'UNI-2026-W2-C111', NULL)
ON CONFLICT DO NOTHING;
...
VALUES
	...
	-- user-provided payment for rrrrr111-1
	(gen_random_uuid(), 'rrrrr111-rrrr-4rrr-8rrr-rrrrrrrrrrr1', 50000.00, 'VNPAY', 'VNPAY-20260504-0001', 'idemp-pay-w1-c111', 'SUCCESS')
ON CONFLICT DO NOTHING;
